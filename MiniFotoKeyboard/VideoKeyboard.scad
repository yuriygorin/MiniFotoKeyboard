...
KeyPad_Horz_dimentions = [0, 27,   34.5, 20];
KeyPad_Vert_dimentions = [0, 38.5, 39,   39 ];
...
for (0 == KeyPad_Type)
{
    let (KeyPad_Type = 3)
    {
translate([ KeyPad_Horz_dimentions[KeyPad_Type], KeyPad_Vert_dimentions[KeyPad_Type] + Big_Knob_radius + Space, 0])
        import("Knob.stl");
...
translate([KeyPad_Horz_dimentions[KeyPad_Type]+Small_Knob_radius + Space, Vert_distance_steps,0])
    scale([20,20,20])
